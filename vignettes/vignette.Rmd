...
Currently, R implementation of GSA-Lightning is available at Bioconductor and on Github at https://github.com/billyhw/GSALightning.
...
Thus far this guide has only covered independent two-sample tests. In fact, all main functions in GSALightning, i.e. GSALight() and permTestLight(), also support paired two-sample test, multi-class comparisons, and Wilcoxon-rank-sum tests.
